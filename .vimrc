...
" env CUSTOM_VIM_PATH=/opt/vim/bin/vim sh -c '
"                sudo update-alternatives --install /usr/bin/ex ex "${CUSTOM_VIM_PATH}" 110
"                sudo update-alternatives --install /usr/bin/vi vi "${CUSTOM_VIM_PATH}" 110
"                sudo update-alternatives --install /usr/bin/view view "${CUSTOM_VIM_PATH}" 110
"                sudo update-alternatives --install /usr/bin/vim vim "${CUSTOM_VIM_PATH}" 110
"                sudo update-alternatives --install /usr/bin/vimdiff vimdiff "${CUSTOM_VIM_PATH}" 110
"                '
